...
public class VisualPulse : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (image == null) Debug.LogWarning("Le composant Image n'est pas trouv� sur cet objet.");
...
/*        if (circle)
        ...
        if (circle) return "";
            ...
            if (b)
            {
                if (MainEvents.IsDarkLevel)
                    return "GA/UI/ui_test_s�rieux_success"; 
                else
            ...
            {
                if (MainEvents.IsDarkLevel)
                    return "GA/UI/ui_test_s�rieux_fail"; 
                else
    ...
    IEnumerator ChangeSpriteForDuration(float duration, bool state) 
    {
        ...
        if(MainEvents.IsDarkLevel)
            image.sprite = (Sprite)Resources.Load("GA/UI/heart_ui_s�rieux", typeof(Sprite));
        else
    ...
    {
        image.sprite = (Sprite)Resources.Load("GA/UI/heart_ui_s�rieux", typeof(Sprite));
        Circle.sprite = (Sprite)Resources.Load("GA/UI/Dark/ui_cercle_s�rieux",typeof(Sprite));
    }
